    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            if (typeof window.toast === 'function') {
                window.toast(@json(session('message')), { type: 'success', position: 'top-right' });
            }
        });
    </script>
@endif
@if (session()->has('success'))
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            if (typeof window.toast === 'function') {
                window.toast(@json(session('success')), { type: 'success', position: 'top-right' });
            }
        });
    </script>
@endif
@if (session()->has('error'))
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            if (typeof window.toast === 'function') {
                window.toast(@json(session('error')), { type: 'danger', position: 'top-right' });
            }
        });
    </script>
@endif
