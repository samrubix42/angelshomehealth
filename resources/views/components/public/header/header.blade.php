<div x-data="{ 
    ...
    <!-- 2. MAIN STICKY NAVIGATION BAR WITH ANCHOR LINKS (#) -->
    <header class="sticky top-0 z-40 bg-[#000000]/95 backdrop-blur-md border-b border-[#27272a]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-14 sm:h-16 lg:h-18">
                ...
                <a href="#home" class="flex items-center py-1 group">
                ...
                <!-- Desktop Navigation Links (# Anchor Links) -->
                <nav class="hidden lg:flex items-center gap-8 text-sm font-heading font-medium text-[#a1a1aa]">
                    <!-- Home -->
                    <a href="#home" class="text-[#C8A14F] font-semibold hover:text-[#d8b260] transition-colors">
                        Home
                    </a>

                    <!-- About Us Anchor Link -->
                    <a href="#about-trust" class="hover:text-[#C8A14F] transition-colors">
                        About Us
                    </a>

                    <!-- Services Dropdown ONLY (Text Only, No Icons, # Anchor Links) -->
                    <div class="relative" @mouseenter="servicesOpen = true" @mouseleave="servicesOpen = false">
                        <a href="#services" 
                           class="flex items-center gap-1.5 hover:text-[#C8A14F] transition-colors py-2">
                            <span>Services</span>
                        ...
                        <div x-show="servicesOpen"
                            ...
                            <a href="#services" class="block px-4 py-2 rounded-xl hover:bg-[#121212] hover:text-[#C8A14F] text-xs text-[#d4d4d8] transition-colors">
                    ...
                    <!-- Blog Anchor Link -->
                    <a href="#testimonials" class="hover:text-[#C8A14F] transition-colors">
                        Blog
                    </a>

                    <!-- Contact Anchor Link -->
                    <a href="#consultation" class="hover:text-[#C8A14F] transition-colors">
                        Contact
                    </a>
                </nav>
    ...
    <div x-show="mobileOpen" 
        ...
        <div class="flex items-center justify-between pb-6 border-b border-[#27272a]">
            <a href="#home" @click="mobileOpen = false" class="flex items-center">
        ...
        <!-- Main Navigation Links (# Anchor Links) -->
        <div class="py-6 space-y-4 flex-grow">
            
            <!-- Home Link -->
            <div>
                <a href="#home" @click="mobileOpen = false" class="block font-heading font-bold text-xl text-[#C8A14F] transition-colors">
                    Home
                </a>
            </div>
            ...
            <div class="border-t border-[#1f1f23] pt-3.5">
                <a href="#about-trust" @click="mobileOpen = false" class="block font-heading font-bold text-lg text-white hover:text-[#C8A14F] transition-colors">
                    About Us
                </a>
            </div>

            <!-- Services Accordion (Text Only, No Icons, # Anchor Links) -->
            <div class="border-t border-[#1f1f23] pt-3.5">
                ...
                <div x-show="mobileServicesOpen" x-collapse class="pl-3 pt-3 space-y-2.5 font-medium text-xs text-[#a1a1aa]">
                    ...
                    <a href="#services" @click="mobileOpen = false" class="block hover:text-[#C8A14F] py-1 border-b border-[#1f1f23]">Skilled Nursing & Rehab</a>
                    <a href="#services" @click="mobileOpen = false" class="block hover:text-[#C8A14F] py-1 border-b border-[#1f1f23]">Physical & Occupational Therapy</a>
                    <a href="#services" @click="mobileOpen = false" class="block hover:text-[#C8A14F] py-1 border-b border-[#1f1f23]">Behavioral Health Services</a>
                    <a href="#services" @click="mobileOpen = false" class="block hover:text-[#C8A14F] py-1 border-b border-[#1f1f23]">Chronic Disease Management</a>
                    <a href="#services" @click="mobileOpen = false" class="block hover:text-[#C8A14F] py-1">Alzheimer's & Memory Care</a>
                </div>
            </div>

            <!-- Blog Link -->
            <div class="border-t border-[#1f1f23] pt-3.5">
                <a href="#testimonials" @click="mobileOpen = false" class="block font-heading font-bold text-lg text-white hover:text-[#C8A14F] transition-colors">
                    Blog
                </a>
            </div>
            ...
            <!-- Contact Link -->
            <div class="border-t border-[#1f1f23] pt-3.5">
                <a href="#consultation" @click="mobileOpen = false" class="block font-heading font-bold text-lg text-white hover:text-[#C8A14F] transition-colors">
                    Contact
                </a>
            </div>
        ...
        <div class="pt-5 border-t border-[#27272a] space-y-4">
            ...
            <a href="#consultation" @click="mobileOpen = false" class="block text-center bg-[#C8A14F] hover:bg-[#d8b260] text-[#000000] font-heading font-bold py-3.5 rounded-full uppercase tracking-wider text-xs shadow-xl transition-all">
                Schedule Consultation
            </a>
        </div>
