<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between gap-4 pb-2 border-b border-zinc-200/80">
        <div class="space-y-1">
            <div class="flex items-center gap-2">
                ...
                <span class="text-xs text-zinc-500 font-medium">New Article</span>
            </div>
        ...
        <div class="flex items-center gap-2">
            ...
            <button type="submit" form="blog-add-form" class="px-5 py-2 rounded-lg bg-zinc-900 text-zinc-50 font-medium text-xs hover:bg-zinc-800 transition-all shadow-xs inline-flex items-center gap-1.5 cursor-pointer">
    ...
    <!-- 2. MAIN FORM CARD -->
    <form id="blog-add-form" wire:submit.prevent="save" class="space-y-6">
