<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between gap-4 pb-2 border-b border-zinc-200/80">
        <div class="space-y-1">
            <div class="flex items-center gap-2">
                ...
                <span class="text-xs text-zinc-500 font-medium">Edit Record #{{ $serviceId }}</span>
            </div>
        ...
        <div class="flex items-center gap-2">
            ...
            <button type="submit" form="service-update-form" class="px-5 py-2 rounded-lg bg-zinc-900 text-zinc-50 font-medium text-xs hover:bg-zinc-800 transition-all shadow-xs inline-flex items-center gap-1.5">
    ...
    <!-- 2. MAIN FORM CARD -->
    <form id="service-update-form" wire:submit.prevent="save" class="space-y-6">
        ...
        <div class="bg-white rounded-xl border border-zinc-200 shadow-xs p-6 space-y-5">
            <h2 class="text-sm font-semibold text-zinc-900 border-b border-zinc-100 pb-3 flex items-center justify-between">
                ...
                <a href="/services/{{ $slug }}" target="_blank" class="text-xs text-zinc-500 hover:text-zinc-900 inline-flex items-center gap-1 font-medium">
                    <i class="ri-external-link-line"></i> View Live Page
                </a>
            </h2>
